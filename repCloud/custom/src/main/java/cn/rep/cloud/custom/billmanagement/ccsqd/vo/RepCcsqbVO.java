...
public class RepCcsqbVO {
     ...
     * 日程list
     */
    private List<RepCcsqbRcVO> rcList;
    /**
     * 人员list
     */
    private List<RepCcsqbRyVO> ryList;
    ...
    public void setRcList(List<RepCcsqbRcVO> rcList) {
        this.rcList = rcList;
    }

    public List<RepCcsqbRyVO> getRyList() {
        return ryList;
    }

    public void setRyList(List<RepCcsqbRyVO> ryList) {
        this.ryList = ryList;
    }

    public List<RepCcsqbFjbVO> getFjList() {
        return fjList;
    }

    public void setFjList(List<RepCcsqbFjbVO> fjList) {
        this.fjList = fjList;
    }
