...
public class RepCcsqbDTO {
     ...
     * 日程list
     */
    private List<RepCcsqbRcDTO> rcList;
    /**
     * 人员list
     */
    private List<RepCcsqbRyDTO> ryList;

    /**
     * 附件list
     */
    private List<RepCcsqbFjbDTO> fjList;
    ...
    public List<RepCcsqbRcDTO> getRcList() {
        return rcList;
    }

    public void setRcList(List<RepCcsqbRcDTO> rcList) {
        this.rcList = rcList;
    }

    public List<RepCcsqbRyDTO> getRyList() {
        return ryList;
    }

    public void setRyList(List<RepCcsqbRyDTO> ryList) {
        this.ryList = ryList;
    }

    public List<RepCcsqbFjbDTO> getFjList() {
        return fjList;
    }

    public void setFjList(List<RepCcsqbFjbDTO> fjList) {
        this.fjList = fjList;
    }
}
